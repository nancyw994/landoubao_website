...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-gray-warm">
      ...
      {/* Hero Section */}
      <section className="bg-black py-fluid-3xl">
        <div className="container-fluid">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-fluid-5xl font-bold text-yellow-400 mb-fluid-lg">关于蓝豆包</h1>
            <p className="text-fluid-xl text-white leading-relaxed mb-fluid-xl px-8 py-12">
              蓝豆包成立于2024年，由90%清华北大顶尖人才组成的专业团队创立。我们既是在人工智能领域深耕多年的技术专家，更是对儿童教育怀有深度思考的教育实践者。致力于用前沿科技重新定义儿童学习体验，用温暖陪伴守护每一个纯真童年。
            </p>

            {/* Stats Grid */}
            <div className="grid grid-cols-4 gap-fluid-lg">
              {stats.map((stat, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-fluid-lg shadow-sm border border-white/20">
                  <stat.icon className="h-8 w-8 text-yellow-400 mx-auto mb-fluid-sm" />
                  <div className="text-fluid-2xl font-bold text-yellow-400 mb-fluid-xs">{stat.number}</div>
                  <div className="text-fluid-sm font-medium text-white">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-fluid-3xl bg-white">
        <div className="container-fluid space-y-fluid-3xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-fluid-2xl items-start">
            <div>
              <h2 className="text-fluid-2xl font-bold text-primary mb-fluid-lg">我们的故事</h2>
          ...
          <div className="text-center max-w-8xl mx-auto mt-fluid-3xl">
            <div className="bg-gradient-to-r from-blue-primary to-purple-600 rounded-2xl p-fluid-lg text-white">
              <div className="flex items-center gap-fluid-md justify-center flex-wrap">
              <div className="bg-black backdrop-blur-md px-8 py-10 shadow-md w-full mb-10">
                  <h4 className="text-fluid-2xl font-bold mb-fluid-xl text-yellow-500">
                    让每一个孩子更聪明、更健康、更快乐
                  </h4>
      ...
      <section className="py-fluid-3xl bg-gradient-to-br from-slate-100 to-blue-soft">
        <div className="container-fluid">
          <div className="text-center mb-fluid-2xl">
            ...
            <p className="text-fluid-xl text-secondary max-w-prose mx-auto mb-10">见证蓝豆包五年来从创想萌芽到行业领军的精彩蜕变历程</p>
          </div>
                      ...
                      <Card className="bg-white shadow-lg hover:shadow-xl transition-all">
                        <CardContent className="p-fluid-lg">
                          <div className="flex items-center gap-fluid-sm mb-fluid-md">
                            <div className="bg-yellow-500 text-black px-fluid-md mb-1 py-fluid-xs rounded-full text-fluid-sm font-bold">
                              {event.year}
                            </div>
      ...
      <section className="py-fluid-3xl bg-gradient-to-br from-blue-primary to-purple-600">
        <div className="container-fluid">
          <div className="text-center text-white max-w-4xl mx-auto">
            <h2 className="text-fluid-3xl font-bold mb-fluid-lg text-black">我们的愿景</h2>
            <p className="text-fluid-xl text-blue-100 leading-relaxed text-secondary mb-fluid-xl mb-10">
